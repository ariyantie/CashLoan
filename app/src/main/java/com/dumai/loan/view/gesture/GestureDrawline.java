package com.dumai.loan.view.gesture;
...
import com.dumai.loan.global.Constant;
import com.dumai.loan.util.AppUtil;
import com.dumai.loan.view.gesture.entity.GesturePoint;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pointAt == null
                        ...
                        || Constant.POINT_STATE_SELECTED == pointAt
                        .getPointState()) {
                    ...
                    if (betweenPoint != null
                            && Constant.POINT_STATE_SELECTED != betweenPoint
                            .getPointState()) {
                        // 存在中间点并且没有被选中
